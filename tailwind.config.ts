  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 4px 24px -4px hsl(var(--primary) / 0.1)',
        'card-hover': '0 20px 40px -12px hsl(var(--primary) / 0.2)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 15px hsl(var(--success) / 0.4)" },
          "50%": { boxShadow: "0 0 25px hsl(var(--success) / 0.6)" },
        },
        shimmer: {
      ...
      backgroundImage: {
        ...
        'gradient-fintech': 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--accent)), hsl(var(--secondary)))',
